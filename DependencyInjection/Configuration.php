                ...
                ->arrayNode('templates')
                    ...
                    ->children()
                        ->arrayNode('form')
                            ...
                            ->defaultValue(['SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'])
                        ->end()
                        ->arrayNode('filter')
                            ->prototype('scalar')->end()
                            ->defaultValue(['SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'])
                        ->end()
                        ->arrayNode('types')
                            ->children()
                                ->arrayNode('list')
